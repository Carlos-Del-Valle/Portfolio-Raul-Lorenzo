        ...
        <div className="h-[85vh] flex flex-row mb-20">
          ...
          <div className="w-6/12 h-6/6 border-blue-700 border flex flex-col justify-center">
            ...
            <p className="w-5/12 h-auto ml-20 text-start">
              ...
              the city of Valencia by equating written language with visual
              language and bringing them closer to the concept of illegibility
              present in ruins.
              <br />
              <br />
        ...
        <div className="h-[85vh] flex flex-row mb-20">
          ...
          <div className="w-6/12 h-6/6 border-blue-700 border flex flex-col justify-center">
            ...
            <div className="w-5/12 h-auto ml-20 text-start">
              <h4 className="font-bold mb-2"> HEEEE, 2018</h4>
              <p>
        ...
        <div className="h-[85vh] flex flex-row mb-20">
          ...
          <div className="w-6/12 h-6/6 border-rose-700 border">
            <p className="w-5/12 h-auto ml-20 mt-24 text-start">
              ...
              <br />
              Additionally, I created drawings using a drawbot and combined them
              with steel plates, thus merging elements of technical blueprint
          ...
          <div className="w-6/12 h-6/6 border-blue-700 border">
            <img
              ...
              title="Sin vuestro hierro caería la noche 1 de 4 "
              className="w-full h-full object-contain"
            />
          </div>
        </div>
        <div className="h-[85vh] flex flex-row mb-20">
          ...
          <div className="w-6/12 h-6/6 border-rose-700 border">
            <img
              ...
              alt="foto de la obra Sin vuestro hierro caería la noche"
              title="Sin vuestro hierro caería la noche 2 de 4 "
        ...
        <div className="h-[85vh] flex flex-row mb-20">
          ...
          <div className="w-6/12 h-6/6 border-rose-700 border flex flex-col justify-center">
            ...
            <div className="w-5/12 h-auto ml-20 text-start">
              ...
              <p>
                Ceramics, steel, tracing paper, vegetable oil <br />
                600x300x430 cm. <br />
                Museo de Zamora
              </p>
            </div>
          ...
          <div className="w-6/12 h-6/6 border-blue-700 border flex justify-center">
            <img
              ...
              alt="foto de la obra Sin vuestro hierro caería la noche"
              title="Sin vuestro hierro caería la noche 2 de 4 "
              className="w-12/12 h-full object-contain"
            />
          </div>
        </div>
      </div>
        ...
        <div className="h-[85vh] flex flex-row mb-20">
          ...
          <div className="w-3/12 h-6/6 border-rose-700 border flex flex-row justify-start">
            <p className="w-9/12 h-auto border border-pink-700 mt-[3.7rem] ml-20">
              ...
              we explored an extensive archive of sculptural digitizations from
              various eras and cultures. <br />
              <br />
        ...
        <div className="h-[85vh] flex flex-row mb-20">
          ...
          <div className="w-6/12 h-6/6 border-blue-700 border flex flex-col justify-center">
            ...
            <p className="w-[51%] h-auto ml-20 text-start">
              ...
              conducted with the artist Marina González Guerreiro at the Estrany
              de la Mota gallery for the Blueproject Foundation. The exhibition
              became a meeting point of our shared personal journey as artists.
              <br />
              <br />
              For this show, I dedicated myself to creating a series of steel
              sculptures and a series of works called “Derrame.” These
              sculptures, resembling steel canvases, incorporated material from
              other melted metals onto their surface, subjecting the objects to
              the violence of metallurgical processes that leave a trace and
              receive these incidents in a pictorial way.
            </p>
          </div>
        </div>
        <div className="h-[85vh] flex flex-row mb-20">
        ...
        <div className="h-[85vh] flex flex-row mb-20">
          ...
          <div className="w-6/12 h-6/6 border-blue-700 border flex flex-col justify-center">
            ...
            <div className="w-5/12 h-auto ml-20 text-start mb-8">
              ...
              <p>Steel, copper, brass, nickel, cotton, printed PLA</p>
            </div>

            <div className="w-5/12 h-auto ml-20 text-start mb-8">
              <h4 className="font-bold mb-2">Derrame series, 2023</h4>
              <p>
                Metal canvases <br />
            ...
            <div className="w-5/12 h-auto ml-20 text-start mb-8">
              <p>Estrany de la Mota Gallery, Barcelona</p>
            </div>
          </div>
        </div>
      </div>
